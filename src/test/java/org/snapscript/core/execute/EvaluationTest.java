...
import org.snapscript.core.execute.Assembler;
...
public class EvaluationTest extends TestCase {   
   ...
   public static Object executeScript(String source, Map<String, Object> model) throws Exception {
      String script = load(new File("C:\\Work\\development\\github\\snapscript\\src\\test\\java\\org\\snapscript\\parse\\"+source));
   ...
   public static ResultFlow statement(String source, String grammar, Map<String, Object> map) throws Exception {
      ...
      Assembler builder = new Assembler(generator, cc);
