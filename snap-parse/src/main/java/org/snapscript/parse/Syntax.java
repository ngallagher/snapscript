...
public enum Syntax {
   ...
   THIS("this", "'this'"),
   CLASS("class", "'class'"),
   VARIABLE("variable", "{<this>|<class>|[identifier]|[type]}"),
   ...
   CONDITIONAL_STATEMENT("conditional-statement", "{<if-statement>|<while-statement>|<for-statement>|<for-in-statement>}"),
   ...
   ENUM_VALUE("enum-value", "<type-name>?('('<argument-list>')')"),
