...
public enum Syntax {
   ...
   STATEMENT("statement", "{<control-statement>|<try-statement>|<assert-statement>|<expression-statement>|<conditional-statement>|<declaration-statement>|<group-statement>|<terminal-statement>}"),
   ...
   PARAMETER_DECLARATION("parameter-declaration", "<parameter-name>?<variable-argument>?(':'<constraint>)"),
   ...
   MEMBER_FIELD("member-field", "<modifier-list><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   MEMBER_FUNCTION("member-function", "<modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
   ...
   TRAIT_FUNCTION("trait-function", "?<modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),
   ...
   ENUM_FIELD("enum-field", "<modifier-list><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   ENUM_FUNCTION("enum-function", "<modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
   ...
   SCRIPT_STATEMENT("script-statement", "{<try-statement>|<declaration-statement>|<assert-statement>|<conditional-statement>|<type-definition>|<module-definition>|<expression-statement>}"),
