...
public enum Syntax {
   ...
   ANNOTATION_DECLARATION("annotation-declaration", "'@'<type-name>"),
   ...
   CLASS_FIELD("class-field", "<member-declaration><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   CLASS_FUNCTION("class-function", "<member-declaration><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
   CLASS_CONSTRUCTOR("class-constructor", "<member-declaration>'new''('<parameter-list>')'?(':'{<this-constructor>|<super-constructor>})<group-statement>"),
   ...
   TRAIT_FUNCTION("trait-function", "?<member-declaration><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),
   ...
   ENUM_CONSTRUCTOR("enum-constructor", "<member-declaration>'new''('<parameter-list>')'<group-statement>"),
   ENUM_FIELD("enum-field", "<member-declaration><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   ENUM_FUNCTION("enum-function", "<member-declaration><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
