...
public enum Syntax {
   ...
   CONSTRUCT_ARRAY("construct-array", "<type-reference>{'[]'|'['+<array-entry-list>']'}"),
   CONSTRUCT_OBJECT_ARRAY("construct-object-array", "'new'' '<type-reference>+('['<argument>']')"),
   ...
   CONSTRAINT("constraint", "{<type-constraint>|<function-constraint>}"),
