...
public enum Syntax {
   ...
   REFERENCE("reference", "<reference-navigation>"),
   ...
   CONDITIONAL_STATEMENT("conditional-statement", "{<if-statement>|<while-statement>|<for-statement>|<for-in-statement>|<loop-statement>|<switch-statement>}"),
   ...
   SWITCH_STATEMENT("switch-statement", "'switch''('<reference>')''{'*<value-case>?<default-case>'}'"),
   VALUE_CASE("value-case", "'case'?' '<value-operand>':'*<statement>"),
   DEFAULT_CASE("default-case", "'default'':'*<statement>"),
   ...
   ANNOTATION_DECLARATION("annotation-declaration", "'@'<type-name>?<annotation-attributes>"),
   ...
   MEMBER_DECLARATION("member-declaration", "<annotation-list><modifier-list>"),
   SUPER_CONSTRUCTOR("super-constructor", "'super('<argument-list>')'"),
   THIS_CONSTRUCTOR("this-constructor", "'this('<argument-list>')'"),
   CLASS_FIELD("class-field", "<annotation-list><modifier-list><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   CLASS_FUNCTION("class-function", "<annotation-list><modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
   CLASS_CONSTRUCTOR("class-constructor", "<annotation-list><modifier-list>'new''('<parameter-list>')'?(':'{<this-constructor>|<super-constructor>})<group-statement>"),
   ...
   TRAIT_FUNCTION("trait-function", "?<annotation-list><modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),
   ...
   ENUM_CONSTRUCTOR("enum-constructor", "<annotation-list><modifier-list>'new''('<parameter-list>')'<group-statement>"),
   ENUM_FIELD("enum-field", "<annotation-list><modifier-list><assignment-variable>?(':'<constraint>)?('='<assignment-expression>)';'"),
   ENUM_FUNCTION("enum-function", "<annotation-list><modifier-list><function>'('<parameter-list>')'?(':'<constraint>){';'|<group-statement>}"),   
   ...
   MODULE_FUNCTION("module-function", "'function'' '<function>'('<parameter-list>')'?(':'<constraint>)<group-statement>"),
   ...
   MODULE_DEFINITION("module-definition", "?<annotation-list>'module'' '<module-name>{<empty-statement>|'{'*{<module-function>|<module-statement>}'}'}"),   
