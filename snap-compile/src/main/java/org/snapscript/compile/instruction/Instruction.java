...
public enum Instruction {
   ...
   FUNCTION_INVOCATION(FunctionInvocation.class, "function-invocation", false),           
   ...
   POSTFIX_INCREMENT(PostfixIncrement.class, "postfix-increment", true),
   POSTFIX_DECREMENT(PostfixDecrement.class, "postfix-decrement", true),
   PREFIX_INCREMENT(PrefixIncrement.class, "prefix-increment", true),
   PREFIX_DECREMENT(PrefixDecrement.class, "prefix-decrement", true),
   ...
   CONSTRUCT_ARRAY(ConstructArray.class, "construct-array", false),
   CONSTRUCT_LIST(ConstructList.class, "construct-list", false),
   CONSTRUCT_OBJECT_ARRAY(ConstructObjectArray.class, "construct-object-array", false),
   CONSTRUCT_OBJECT(ConstructObject.class, "construct-object", false),
   CONSTRUCT_MAP(ConstructMap.class, "construct-map", false),   
   CONSTRUCT_SET(ConstructSet.class, "construct-set", false),
   ...
   DECLARATION_STATEMENT(DeclarationStatement.class, "declaration-statement", false),
   ASSIGNMENT_STATEMENT(AssignmentStatement.class, "assignment-statement", false),      
   EXPRESSION_STATEMENT(ExpressionStatement.class, "expression-statement", false),
   ...
   IF_STATEMENT(IfStatement.class, "if-statement", false),
   BREAK_STATEMENT(BreakStatement.class, "break-statement", false),
   CONTINUE_STATEMENT(ContinueStatement.class, "continue-statement", false),
   RETURN_STATEMENT(ReturnStatement.class, "return-statement", false),      
   WHILE_STATEMENT(WhileStatement.class, "while-statement", false),
   FOR_STATEMENT(ForStatement.class, "for-statement", false),
   FOR_INFINITE_STATEMENT(ForInfiniteStatement.class, "for-infinite-statement", false),
   FOR_IN_STATEMENT(ForInStatement.class, "for-in-statement", false),
   ...
   THROW(ThrowStatement.class, "throw-statement", false),    
   TRY_CATCH(TryCatchStatement.class, "try-catch-statement", false),
   TRY_FINALLY(TryFinallyStatement.class, "try-finally-statement", false),      
