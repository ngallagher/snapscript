...
public enum Instruction {
   ...
   TRAIT_FUNCTION(TraitFunction.class, "trait-function", true),
   ...
   MEMBER_FUNCTION(MemberFunction.class, "member-function", true),   
   MEMBER_CONSTRUCTOR(MemberConstructor.class, "member-constructor", true),        
   ...
   MODULE_FUNCTION(FunctionDeclaration.class, "module-function", true),     
   MODULE_DEFINITION(ModuleDefinition.class, "module-definition", false),    
   SCRIPT_FUNCTION(FunctionDeclaration.class, "script-function", true),
