...
import org.snapscript.compile.instruction.BreakStatement;
import org.snapscript.compile.instruction.CompoundStatement;
import org.snapscript.compile.instruction.Constraint;
import org.snapscript.compile.instruction.ContinueStatement;
import org.snapscript.compile.instruction.DeclarationStatement;
import org.snapscript.compile.instruction.DeclareConstant;
import org.snapscript.compile.instruction.DeclareVariable;
import org.snapscript.compile.instruction.Expression;
import org.snapscript.compile.instruction.ExpressionStatement;
import org.snapscript.compile.instruction.FullQualifier;
import org.snapscript.compile.instruction.FunctionDeclaration;
import org.snapscript.compile.instruction.FunctionInvocation;
import org.snapscript.compile.instruction.Import;
import org.snapscript.compile.instruction.ImportStatic;
import org.snapscript.compile.instruction.NoOperation;
import org.snapscript.compile.instruction.NullLiteral;
import org.snapscript.compile.instruction.NumberLiteral;
import org.snapscript.compile.instruction.Parameter;
import org.snapscript.compile.instruction.ParameterList;
import org.snapscript.compile.instruction.ReferenceList;
import org.snapscript.compile.instruction.ReferencePart;
import org.snapscript.compile.instruction.ReturnStatement;
import org.snapscript.compile.instruction.Script;
import org.snapscript.compile.instruction.TextLiteral;
import org.snapscript.compile.instruction.TextTemplate;
import org.snapscript.compile.instruction.ThrowStatement;
import org.snapscript.compile.instruction.TryCatchStatement;
import org.snapscript.compile.instruction.TryFinallyStatement;
import org.snapscript.compile.instruction.Variable;
import org.snapscript.compile.instruction.WildQualifier;
...
import org.snapscript.compile.instruction.loop.ForInStatement;
import org.snapscript.compile.instruction.loop.ForInfiniteStatement;
import org.snapscript.compile.instruction.loop.ForStatement;
import org.snapscript.compile.instruction.loop.WhileStatement;
