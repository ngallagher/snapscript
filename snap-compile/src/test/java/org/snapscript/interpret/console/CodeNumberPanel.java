 ...
 * a JScrollPane.
 */
public class CodeNumberPanel extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    ...
    */
   public CodeNumberPanel(JTextComponent component) {
      this(component, 3);
   }
    ...
    *           component
    */
   public CodeNumberPanel(JTextComponent component, int minimumDisplayDigits) {
